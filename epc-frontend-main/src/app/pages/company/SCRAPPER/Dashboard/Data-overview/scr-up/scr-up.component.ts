...
import { UpItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';

@Component({
  selector: 'app-scr-up',
  standalone: true,
  imports: [CommonModule, BreadcrumbsComponent],
  templateUrl: './scr-up.component.html',
  styleUrl: './scr-up.component.scss'
})
export class ScrUPComponent {
  breadCrumbItems = signal<breadCrumbItems[]>([]);

  overview = signal<UpItem[]>([]);
  ...
  loadOverview() {
    ...
    this.selectedState.set("uttarpradesh");
