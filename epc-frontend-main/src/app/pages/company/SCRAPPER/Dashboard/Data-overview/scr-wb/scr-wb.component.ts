...
import { ApItem, WbItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';
...
@Component({
  ...
  templateUrl: './scr-wb.component.html',
  styleUrl: './scr-wb.component.scss'
})
export class ScrWBComponent {
  breadCrumbItems = signal<breadCrumbItems[]>([]);

  overview = signal<WbItem[]>([]);
  ...
  loadOverview() {
    ...
    this.selectedState.set("westbengal");
