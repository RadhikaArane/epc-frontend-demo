...
import { TnItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';

@Component({
  selector: 'app-scr-tn',
  standalone: true,
  imports: [CommonModule,BreadcrumbsComponent],
  templateUrl: './scr-tn.component.html',
  styleUrl: './scr-tn.component.scss'
})
export class ScrTNComponent {

  breadCrumbItems = signal<breadCrumbItems[]>([]);
  
    overview = signal<TnItem[]>([]);
    ...
    loadOverview() {
      ...
      this.selectedState.set("Tamilnadu");
