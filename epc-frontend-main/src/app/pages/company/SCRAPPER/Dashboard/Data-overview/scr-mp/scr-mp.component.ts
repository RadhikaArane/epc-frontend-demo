...
import { MpItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';
...
@Component({
  ...
  templateUrl: './scr-mp.component.html',
  styleUrl: './scr-mp.component.scss'
})
export class ScrMPComponent {

  breadCrumbItems = signal<breadCrumbItems[]>([]);

  overview = signal<MpItem[]>([]);
  ...
  loadOverview() {
    ...
    this.selectedState.set("madhyapradesh");
