...
import { GjItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';

@Component({
  selector: 'app-scr-gj',
  standalone: true,
  imports: [CommonModule,BreadcrumbsComponent],
  templateUrl: './scr-gj.component.html',
  styleUrl: './scr-gj.component.scss'
})
export class ScrGJComponent {
  breadCrumbItems = signal<breadCrumbItems[]>([]);

  overview = signal<GjItem[]>([]);
  ...
  loadOverview() {
    ...
    this.selectedState.set("Gujarat");
