...
import { CgItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';
...
@Component({
  ...
  templateUrl: './scr-cg.component.html',
  styleUrl: './scr-cg.component.scss'
})
export class ScrCGComponent {
  ...
  loadOverview() {
    ...
    this.selectedState.set("chhattisgarh");
