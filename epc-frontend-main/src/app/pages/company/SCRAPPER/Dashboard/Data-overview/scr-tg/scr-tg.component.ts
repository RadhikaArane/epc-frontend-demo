...
import { TgItem, TnItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';
...
@Component({
  ...
  templateUrl: './scr-tg.component.html',
  styleUrl: './scr-tg.component.scss'
})
export class ScrTGComponent {

    breadCrumbItems = signal<breadCrumbItems[]>([]);

    overview = signal<TgItem[]>([]);
    ...
    this.selectedState.set("telangana");
