...
import { ApItem } from '../../../../../../shared/models/scrapper-models/scrapperDashboard';
...
@Component({
  ...
  templateUrl: './scr-ap.component.html',
  styleUrl: './scr-ap.component.scss'
})
export class ScrAPComponent {

  breadCrumbItems = signal<breadCrumbItems[]>([]);

  overview = signal<ApItem[]>([]);
  ...
  loadOverview() {
    ...
    this.selectedState.set("andhrapradesh");
