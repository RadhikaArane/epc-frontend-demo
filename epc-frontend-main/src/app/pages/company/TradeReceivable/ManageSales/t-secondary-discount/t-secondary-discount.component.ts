...
import { ConsideredRow, ConsideredTotal, CreditNote, Discounts, FreightRecoverynotconsideredasSale, GrossSale, NetSaleAfterAdj, NetSaleBeforeAdj, NotConsideredRow, NotConsideredTotal, InstitutionalSale, SaleReversalRow, SaleReversalTotal, SecondaryDiscountsGetData } from '../../../../../shared/models/tradeReceivable-models/trManageSales';
...
@Component({
  selector: 'app-t-secondary-discount',
  standalone: true,
  imports: [FormsModule, BreadcrumbsComponent, DecimalPipe],
  templateUrl: './t-secondary-discount.component.html',
  styleUrl: './t-secondary-discount.component.scss'
})
export class TSecondaryDiscountComponent implements OnInit, OnDestroy {
  ...
  ReopenSale = signal<InstitutionalSale | null>(null);
    ...
    this.manageSaleSrv._getManageSalesFinalSummary(month, year)
      ...
      .subscribe({
        next: (res: any) => {
          ...
          this.ReopenSale.set(res.ReopenSale);
