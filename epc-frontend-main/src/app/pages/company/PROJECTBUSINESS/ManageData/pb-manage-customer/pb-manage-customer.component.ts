...
import { GetCustomerList } from '../../../../../shared/models/projectBusiness-models/projectmanagement';

declare var bootstrap: any;

@Component({
  selector: 'app-pb-manage-customer',
  standalone: true,
  imports: [CommonModule,BreadcrumbsComponent],
  templateUrl: './pb-manage-customer.component.html',
  styleUrl: './pb-manage-customer.component.scss'
})
export class PbManageCustomerComponent {
    ...
    @ViewChild("AddCustomerUpload") AddCustomerUpload!: ElementRef | undefined;
    ...
    // Pagination signals
      ...
      allCustomers = signal<GetCustomerList[]>([]);
    ...
    OpenModal(): void {
      if (this.AddCustomerUpload) {
        this.resetForm();
        const modalElement = this.AddCustomerUpload.nativeElement;
    ...
    saveCustomer(): void {
      ...
      this.projectSrv._uploadCustomerAttachment(formData)
  ...
  private loadCustomerList(): void {
    ...
    this.projectSrv._getAllCustomerList(params)
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: (res: any) => {
